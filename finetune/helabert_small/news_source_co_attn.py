...
# ==================== CONFIGURATION ====================
print("=" * 80)
print("HelaBERT FINE-TUNING — NEWS SOURCE  [CO-ATTENTION | 5 SEED RUNS]")
print("=" * 80)
...
OUTPUT_DIR    = "HelaBERT_coattention_news_source"
USE_WANDB     = True
WANDB_PROJECT = "helabert-coattention"
WANDB_GROUP   = "news_source_small_5runs_coattn"
...
def load_fresh_model(num_labels):
    ...
    return NewsSourceModelCoAttention(backbone, cfg.hidden_size, num_labels, DROPOUT)
...
for run_idx, seed in enumerate(SEEDS, start=1):
    ...
    train_ds = NewsSourceDataset(train_texts, train_labels, sp, MAX_SEQ_LENGTH)
    test_ds  = NewsSourceDataset(test_texts,  test_labels,  sp, MAX_SEQ_LENGTH)
    ...
    if USE_WANDB:
        ...
        wandb.init(
            ...
            config={
                "task": "news_source", "method": "co_attention",
