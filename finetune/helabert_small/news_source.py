...
MAX_SEQ_LENGTH = 512    # headlines are short (~8 tokens avg) — 512 is sufficient
BATCH_SIZE     = 16
LEARNING_RATE  = 5e-5
NUM_EPOCHS     = 3
DROPOUT        = 0.1
NUM_LABELS     = 9      # 9 news sources
...
# ==================== MODEL ====================
class NewsSourceModel(nn.Module):
    """
...
def load_fresh_model(num_labels):
    ...
    return NewsSourceModel(backbone, cfg.hidden_size, num_labels, DROPOUT)
...
# Dataset columns: Unnamed: 0, comment, label, length
text_col  = 'comment'
label_col = 'label'
...
for run_idx, seed in enumerate(SEEDS, start=1):
    ...
    if USE_WANDB:
        ...
        wandb.init(
            ...
            config={
                "task": "news_source", "method": "paper_sinbert",
