...
OUTPUT_DIR    = "HelaBERT_coattention_writing_style"
USE_WANDB     = True
WANDB_PROJECT = "helabert-coattention"
WANDB_GROUP   = "writing_style_small_5runs_coattn"
...
class WritingStyleDataset(Dataset):
    """Long documents are TRUNCATED to MAX_SEQ_LENGTH tokens (paper method)."""
...
class CoAttention(nn.Module):
    ...
    Direction 2 — tokens attend over [CLS]   → attended_tokens (B, H)
      Uses sigmoid gate + renorm; fp16-safe -1e4 fill prevents NaN.
    """
...
def load_fresh_model(num_labels):
    ...
    return WritingStyleModelCoAttention(backbone, cfg.hidden_size, num_labels, DROPOUT)
...
# Paper pre-processing: remove texts longer than 3500 characters
...
for run_idx, seed in enumerate(SEEDS, start=1):
    ...
    if USE_WANDB:
        ...
        wandb.init(
            ...
            config={
                "task": "writing_style", "method": "co_attention",
