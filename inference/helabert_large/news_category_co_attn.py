...
MODEL_DIR        = "models/new/large/HelaBERT_large_coattention_news_category"
...
OUTPUT_DIR = "results_test/HelaBERT_large_coattention_news_category"

print("=" * 80)
print("HelaBERT_large INFERENCE — NEWS CATEGORY CLASSIFICATION (CO-ATTENTION)")
print("=" * 80)
...
bert  = BertModel(cfg)
model = NewsCategoryModelCoAttention(bert, cfg.hidden_size, num_labels, DROPOUT)
...
print("\n" + "=" * 80)
print("TEST RESULTS — NEWS CATEGORY CLASSIFICATION (CO-ATTENTION)")
print("=" * 80)
