...
MODEL_DIR        = "models/new/HelaBERT_paper_sentiment"
...
bert  = BertModel(cfg)
model = SentimentModel(bert, cfg.hidden_size, num_labels, DROPOUT)
...
# Map string labels to IDs using label_map from training
...
print("\n" + "=" * 80)
print("TEST RESULTS — SENTIMENT ANALYSIS")
print("=" * 80)
