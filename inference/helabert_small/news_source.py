...
MODEL_DIR        = "models/new/HelaBERT_paper_news_source"
...
OUTPUT_DIR = "results_test/HelaBERT_small_news_source"

print("=" * 80)
print("HelaBERT INFERENCE — NEWS SOURCE CLASSIFICATION")
print("=" * 80)
...
# Labels are integers 0–8; label column in test data maps directly to model output indices
...
# Labels are already integer indices matching model output
