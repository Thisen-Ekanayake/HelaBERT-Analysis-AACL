...
MODEL_DIR        = "HelaBERT_coattention_sentiment"
...
OUTPUT_DIR = "results_test/HelaBERT_small_coattention_sentiment"

print("=" * 80)
print("HelaBERT INFERENCE — SENTIMENT ANALYSIS (CO-ATTENTION)")
print("=" * 80)
...
bert  = BertModel(cfg)
model = SentimentModelCoAttention(bert, cfg.hidden_size, num_labels, DROPOUT)
...
text_col  = next(c for c in df.columns if 'comment' in c.lower() and 'sentiment' not in c.lower())
...
print("\n" + "=" * 80)
print("TEST RESULTS — SENTIMENT ANALYSIS (CO-ATTENTION)")
print("=" * 80)
