...
MODEL_DIR        = "models/new/HelaBERT_paper_news_category"
...
OUTPUT_DIR = "results_test/HelaBERT_small_news_category"

print("=" * 80)
print("HelaBERT INFERENCE — NEWS CATEGORY CLASSIFICATION")
print("=" * 80)
